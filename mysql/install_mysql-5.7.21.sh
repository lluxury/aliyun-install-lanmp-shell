...
if [ $machine == "x86_64" ];then
  ...
  if [ ! -f mysql-5.7.21-linux-glibc2.12-x86_64.tar.gz ];then
   # wget http://zy-res.oss-cn-hangzhou.aliyuncs.com/mysql/mysql-5.7.21-linux-glibc2.12-x86_64.tar.gz
	 wget http://mysql.mirror.ac.za/Downloads/MySQL-5.7/mysql-5.7.21-linux-glibc2.12-x86_64.tar.gz

  fi
  tar -xzvf mysql-5.7.21-linux-glibc2.12-x86_64.tar.gz
  mv mysql-5.7.21-linux-glibc2.12-x86_64/* /alidata/server/mysql
else
  rm -rf mysql-5.7.21-linux-glibc2.12-i686
  if [ ! -f mysql-5.7.21-linux-glibc2.12-i686.tar.gz ];then
  wget http://zy-res.oss-cn-hangzhou.aliyuncs.com/mysql/mysql-5.7.21-linux-glibc2.12-i686.tar.gz
  fi
  tar -xzvf mysql-5.7.21-linux-glibc2.12-i686.tar.gz
  mv mysql-5.7.21-linux-glibc2.12-i686/* /alidata/server/mysql
fi
